...
<body>
		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">申领物资管理</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item"><span>申领物资管理</span></li>
								<li class="breadcrumb-item active"><span>申领物资列表</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">申领物资列表</h3>							
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th onclick="sort('lingqushijian')">领取时间<i id="lingqushijianIcon" class="fa fa-sort"></i></th>
	...
	<script>
		...
		function setDataRow(item,number){
			...
			var wuziliuxiangCell  = document.createElement('td');

						  if(item.wuziliuxiang != null && item.wuziliuxiang != "" && item.wuziliuxiang.length >= 11){
			  	wuziliuxiangCell.innerHTML = item.wuziliuxiang.substring(0, 10) + "..."; 
			  }else{
			  	wuziliuxiangCell.innerHTML = item.wuziliuxiang;
			  }


			row.appendChild(wuziliuxiangCell);
			...
			var lingqushijianCell  = document.createElement('td');

						  lingqushijianCell.innerHTML = item.lingqushijian;


			row.appendChild(lingqushijianCell);
		...
		function shDialog(id){
			$("#shId").attr("value",id);
			http("shenlingwuzi/info/" + id,"GET",{},(res)=>{
				if(res.code == 0){
		...
		function sh(){
			...
			httpJson("shenlingwuzi/update","POST",data,(res)=>{
				if(res.code == 0){
					$('#addRowModal').hide();
					alert("提交成功");
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("shenlingwuzi/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
		...
		function crossTable(id,crossTableName){
			...
			window.sessionStorage.setItem('crossTableName',"shenlingwuzi");
