...
<body>
		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">财务报销管理</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item"><span>财务报销管理</span></li>
								<li class="breadcrumb-item active"><span>财务报销列表</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">财务报销列表</h3>							
							<div class="table-responsive mb-3" id="tableDiv">
								<div class="col-sm-12">
									<label>
										申请人
									</label>
									<input type="text" id="shenqingrenSearch" class="form-control form-control-sm" placeholder="" aria-controls="tableId">
									<label>
										负责人
									</label>
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th>报销内容</th>
											<th onclick="sort('baoxiaozongjine')">报销总金额<i id="baoxiaozongjineIcon" class="fa fa-sort"></i></th>
	...
	<script>
		...
		function search(){
			searchForm = { key: ""};
			if($('#shenqingrenSearch').val() != null && $('#shenqingrenSearch').val() != ''){
				searchForm.shenqingren ="%" +  $('#shenqingrenSearch').val() + "%";
			}
        ...
        function getDataList() {
			http("caiwubaoxiao/page","GET",{
				page: pageIndex,
				limit: pageSize,
				sort: sortColumn,
				order: sortOrder,
				shenqingren : searchForm.shenqingren,	
		...
		function setDataRow(item,number){
			...
			var baoxiaoneirongCell  = document.createElement('td');

						  if(item.baoxiaoneirong != null && item.baoxiaoneirong != "" && item.baoxiaoneirong.length >= 11){
			  	baoxiaoneirongCell.innerHTML = item.baoxiaoneirong.substring(0, 10) + "..."; 
			  }else{
			  	baoxiaoneirongCell.innerHTML = item.baoxiaoneirong;
			  }


			row.appendChild(baoxiaoneirongCell);
			var baoxiaozongjineCell  = document.createElement('td');

						 baoxiaozongjineCell.innerHTML = item.baoxiaozongjine;


			row.appendChild(baoxiaozongjineCell);
		...
		function shDialog(id){
			$("#shId").attr("value",id);
			http("caiwubaoxiao/info/" + id,"GET",{},(res)=>{
				if(res.code == 0){
		...
		function sh(){
			...
			httpJson("caiwubaoxiao/update","POST",data,(res)=>{
				if(res.code == 0){
					$('#addRowModal').hide();
					alert("提交成功");
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("caiwubaoxiao/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
		...
		function crossTable(id,crossTableName){
			...
			window.sessionStorage.setItem('crossTableName',"caiwubaoxiao");
